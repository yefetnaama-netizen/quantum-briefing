...
NEWS_FEEDS = [
    ...
    ("AI", gnews('"artificial intelligence" (enterprise OR business OR model OR launch)')),
    ("AI for leaders", gnews('"AI strategy" (CEO OR executives OR board OR leadership)')),
    ("AI governance", gnews('"AI governance" OR "AI regulation" OR "AI Act" OR "responsible AI"')),
    ("Future of work", gnews('("future of work" OR workforce OR reskilling OR jobs) "artificial intelligence"')),
    ("Cybersecurity", gnews('cybersecurity ("artificial intelligence" OR "AI-powered" OR "AI agents")')),
...
RESEARCH_FEEDS = [
    ...
    ("AI governance", arxiv('cat:cs.CY AND (abs:"AI governance" OR abs:"AI regulation" OR abs:"AI policy")', 10)),
    ("Future of work", arxiv('(cat:cs.CY OR cat:econ.GN) AND abs:"labor" AND abs:"artificial intelligence"', 10)),
